...
# COMP9444_Group/src/1_Classifier/1_resnet50/evaluate_resnet.py
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Evaluate a trained ResNet50 checkpoint on IP102.",
    )
...
def create_resnet50_model(device: torch.device) -> nn.Module:
    """Recreate the ResNet50 architecture used by both training scripts."""
