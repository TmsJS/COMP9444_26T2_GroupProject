"""training script for ImageNet-1K-pretrained DeiT-III Base/16("deit3_base_patch16_224.fb_in1k") on IP102."""
...
# Expected location:
# COMP9444_Group/src/1_Classifier/3_deit/train_vit.py
...
BEST_MODEL_PATH = OUTPUT_DIR / "deit3_base_patch16_224_best_model.pth"
...
def create_logger() -> tuple[logging.Logger, Path]:
    ...
    log_path = OUTPUT_DIR / f"deit3_base_patch16_224_trainlog_{timestamp}.txt"

    logger = logging.getLogger("deit3_base_patch16_224_training")
...
def train_one_epoch(
    ...
    for images, labels in progress_bar:
        ...
        # Gradient clipping makes full ViT fine-tuning more stable.
...
def main() -> None:
    ...
    # AdamW is used for full DeiT-III fine-tuning.
    ...
    logger.info("Model: DeiT-III Base/16")
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        if val_macro_f1 > best_macro_f1:
            ...
            torch.save(
                {
                    "architecture": "deit3_base_patch16_224.fb_in1k",
                    "weights": "ImageNet-1K",
                    "image_size": 224,
                    "num_classes": NUM_CLASSES,
                    "dropout": 0.1,
        ...
        if new_learning_rate < previous_learning_rate:
            logger.info(
                ...
                f"{previous_learning_rate:.8f} -> {new_learning_rate:.8f}"
            )
